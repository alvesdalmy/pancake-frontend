  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://dexv2.metaexchange.finance/images/tokens/${token.address[56]}.png`;
        const secondarySrc = `https://dexv2.metaexchange.finance/images/tokens/${tokens[randomTokenIndex].address[56]}.png`;
