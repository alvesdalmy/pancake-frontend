  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:image" content="https://dexv2.metaexchange.finance/images/hero.png" />
        <meta
        ...
        <meta name="twitter:title" content="🥞 Metaexchange - A next evolution DeFi exchange on BNB Smart Chain (BSC)" />
        <title>MetaExchange Bridge</title>
      </Head>
      <NextThemeProvider>
        <StyledThemeProvider>
          <ModalProvider>
